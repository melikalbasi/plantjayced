=== Foodie Pro 4.4.1 Genesis Child Theme ===
...
* Replace nav menu icon output from aside to section for accessibility compliance
* Further update to default colors for accessibility compliance
